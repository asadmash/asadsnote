...
export default function ArticleOutdateTip({
  ...
  return (
    ...
    <div className={twMerge(
      ...
      <p className='inline align-middle'>This article was last updated on {distance}，The content in this article may be outdated, please be careful to distinguish it.</p>
    </div>
  )
}
