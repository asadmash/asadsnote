    ...
    <footer className={twMerge(
      ...
      <div {...rest} className={twMerge(
        ...
        {/* <div className='flex flex-wrap gap-x-3'>
          ...
          {rss && <a href={url('rss/feed.xml')} target='_blank' className='whitespace-nowrap'><IconRss className='inline align-[-3px] mr-1' />RSS Feed</a>}
          {sitemap && <a href={url('sitemap-index.xml')} target='_blank' className='whitespace-nowrap'><IconSitemap className='inline align-[-3px] mr-1' />Sitemap</a>}
        </div> */}
      </div>
    </footer>
